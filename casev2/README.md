...
- **Startup recovery** — On startup, all broker auth hashes and all open non-expired orders are loaded into memory (FIFO order preserved) before the persistence loop starts.
